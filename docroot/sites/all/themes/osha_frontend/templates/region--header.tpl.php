...
<div id="languagesAndSearch">
	<div id="contact"><a href="/articles/news-events"><?php print l(t('News & Events'), 'articles/news-events') ?> | <?php print l(t('Press'), 'inside-eu-osha/press-room') ?> |  <?php print l(t('Contact Us'), 'contact-us') ?> <span class="a_small"><a  onclick="zoomSmall()">a</a></span><span class="a_medium"><a onclick="zoomMedium()">a</a></span><span class="a_big"><a  onclick="zoomBig()">a</a></span></div>
	<div>
